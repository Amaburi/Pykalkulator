...
Button(root,
       ...
       fg="#FFF",
       bg="#22A39F",
       command=lambda: clear()).place(x=150, y=100)
Button(root,
       text="←",
       width=5,
       height=1,
       ...
       fg="#FFF",
       bg="#22A39F",
       command=lambda: logarithm()).place(x=10, y=100)
Button(root,
       text="/",
       width=5,
       height=1,
...
Button(root,
       ...
       fg="#FFF",
       bg="#434242",
       command=lambda: show("7")).place(x=10, y=400)
Button(root,
       text="8",
       width=5,
       height=1,
       ...
       fg="#FFF",
       bg="#434242",
       command=lambda: show("8")).place(x=150, y=400)
Button(root,
       text="9",
       width=5,
       height=1,
       ...
       fg="#FFF",
       bg="#434242",
       command=lambda: show("9")).place(x=290, y=400)
Button(root,
       text="-",
       width=5,
       height=1,
...
Button(root,
       ...
       fg="#FFF",
       bg="#434242",
       command=lambda: show("1")).place(x=10, y=200)
Button(root,
       text="2",
       width=5,
       height=1,
       ...
       fg="#FFF",
       bg="#434242",
       command=lambda: show("2")).place(x=150, y=200)
Button(root,
       text="3",
       width=5,
       height=1,
       ...
       fg="#FFF",
       bg="#434242",
       command=lambda: show("3")).place(x=290, y=200)
Button(root,
       text="0",
       width=5,
       height=1,
...
Button(root,
       ...
       fg="#FFF",
       bg="#434242",
       command=lambda: show(".")).place(x=150, y=500)
Button(root,
       text=".",
       width=5,
       height=1,
